...
export default function Home({ data, go }) {
  ...
  const duns = Object.entries(m.dun)
    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card title="Beban mengikut DUN">
          ...
          <p className="mt-3 border-t border-stone-100 pt-3 text-xs text-stone-500">
            Jurang {Math.round(duns[0][1] / duns[duns.length - 1][1])}× antara DUN tertinggi dan
            terendah — isu ekuiti perkhidmatan, bukan sekadar isu volum.
          </p>
        </Card>
      </div>
